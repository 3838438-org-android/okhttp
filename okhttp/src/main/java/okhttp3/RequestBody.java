...
public abstract class RequestBody {
   ...
   * <p>This method returns false unless it is overridden by a subclass.
   *
   * <p>OkHttp may attempt to retransmit request bodies when the original request fails due to a
   * stale connection, a client timeout (HTTP 408), a satisfied authorization challenge (HTTP 401
   * and 407), or a retryable server failure (HTTP 503 with a {@code Retry-After: 0} header).
   */
